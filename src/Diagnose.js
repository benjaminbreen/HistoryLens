  ...
  const generateDiagnosis = async (previousOutput, patient) => {
    ...
    try {
      const diagnosisPrompt = `
        ...
        **Recent Observations:**
        ${previousOutput}
        Use period-appropriate medical concepts to depict Maria de Lima's thought process as she diagnoses the patient. Portray her thoughts in a plainspoken, simple (no "hath" or "thou"!), stream of consciousness style, almost like notes to herself, blunt and to the point, unsparing, citing relevent 17th century and earlier authorities frequently, with materia medica she considers using in **bold italic**. Limit your response to three paragraphs.
      `;
