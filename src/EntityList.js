...
// Patients
{
   type: "patient",
    ...
    birthplace: "Puebla",
    currentResidence: "Mexico City, Bica de Duarte Bello",
    casta: "Criollo",
    class: "Merchant class",
    symptoms: [
      { name: "Ardent fever", location: "head", quote: "My head burns as though a thousand candles are aflame within it, señora. I fear the devil’s fire has taken root in my mind." },
      { name: "Burning tenesmus", location: "abdomen", quote: "A fiery pain seizes my belly, as if a serpent coils within, gnawing at my entrails day and night." },
      { name: "Severe abdominal pain", location: "abdomen", quote: "Each morsel I take is met with sharp torment." },
      { name: "Pain in both legs", location: "legs", quote: "My legs, once strong as the oak, now feel like brittle reeds, trembling under the weight of this cursed malady." }
    ],
    diagnosis: "Syphilis",
    contemporaryTheory: "Malignant fever caused by the French Pox",
    socialContext: "Significant disruption to his business affairs and local textile trade",
    urgency: "Medium",
    image: "araujo",
    caption: "Francisco Dias de Araujo, merchant",
    description: "Francisco Dias de Araujo, a merchant of textiles, looks weak and somewhat confused. His face is gaunt, and his business is in jeopardy.",
...

  {
    ...
    quest: "Fernando seeks to learn why Maria fled Portugal - a path that may lead to her being put before trial in some playthroughs."
  },

  {
    ...
    quest: "Juan is scheming to frame Maria for counterfeiting medicinal mummy. He may try to plant evidence in her shop or spread rumors to tarnish her reputation."
  },
  {
    type: "npc",
    name: "João",
    ...
    quest: "João has fallen ill, and Maria must use her knowledge of herbs to diagnose and treat her beloved kitten. The challenge is finding the right remedy in time."
  },
  {
    type: "npc",
    ...
    quest: "Marta needs Maria's help to identify a rare herb she found in the mountains. This herb could be the key to curing a mysterious illness spreading in a nearby village."
  },
  {
    type: "npc",
    ...
    quest: "Don Luis demands an additional 20 reales in interest by the next morning, or Maria risks losing her shop. She must find a way to gather the money quickly."
  }
];
