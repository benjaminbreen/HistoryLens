...
const Mixing = ({
    ...
    // Define the methods with their details
    const allMethods = [
        {
            name: 'Distill',
            image: distillImage,
        ...
        <div className={`mixing-container ${isLoading ? 'loading' : ''}`}>
            ...
            {!compoundResult ? (
                <p className="mixing-instructions">
                    Drag and drop inventory items into one of the available method options below and then click the Mix Drug button to create new compound remedies.
                </p>
            ) : (
                <p className="mixing-instructions">
                ...
                <div className="compound-result">
                    <div className="compound-item">
                        ...
                        <div className="item-details">
                            ...
                            <strong>Price:</strong> {compoundResult.price} silver &emsp;
                            <strong>Humoral Qualities:</strong> {compoundResult.humoralQualities}<br />
                            <strong>Effects:</strong> {compoundResult.medicinalEffects}<br />
                            <em>{compoundResult.description}</em>
                            <br />
                            <strong>Citation:</strong> {compoundResult.citation}
                        </div>
                    </div>
                </div>
            )}
